    ...
    switch($_GET["op"]){
        ...
        case "listar_x_usu":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="verdetalle('.$row["tick_id"].');"  id="'.$row["tick_id"].'" class="btn btn-inline btn-primary btn-sm ladda-button"><i class="fa fa-eye"></i></button>';
                $data[] = $sub_array;
            }
