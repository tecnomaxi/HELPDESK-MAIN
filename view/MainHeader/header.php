<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            <img class="hidden-md-down" src="../../public/img/logo-tic.png" alt="">
            <img class="hidden-lg-up" src="../../public/img/logo-2-tic.png" alt="">
        </a>
            ...
            <div class="site-header-content-in">
                <div class="site-header-shown">
                    <div class="dropdown user-menu">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                            <a class="dropdown-item" href="../MntPerfil/"><span
                ...
                <div class="dropdown dropdown-typical">
                    <a href="#" class="dropdown-toggle no-arr">
                        ...
                        <span class="lblcontactonomx"><?php echo $_SESSION["usu_nom"] ?>
                            <?php echo $_SESSION["usu_ape"] ?></span>
                    </a>
                </div>
